<div>
    ...
    <div class="glass rounded-2xl shadow-xl shadow-indigo-500/5 p-6 mb-8">
        <div class="flex flex-col md:flex-row gap-4 justify-between items-center mb-6">
            ...
            {{-- Tombol Export Excel --}}
            @php
                $prefix = request()->segment(1); // admin, dewan, eksekutif
                $exportRoute = $prefix . '.pengaduan.export';
            @endphp
            <a href="{{ route($exportRoute) }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-bold rounded-xl shadow-sm hover:shadow-md transition-all whitespace-nowrap">
