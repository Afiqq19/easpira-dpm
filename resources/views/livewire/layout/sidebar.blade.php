<div x-cloak :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'" 
    ...
    <nav class="flex-1 overflow-y-auto py-3 px-3 space-y-1">
        ...
        @role('admin')
            ...
            <a href="{{ route('admin.periode.index') }}" wire:navigate @click="sidebarOpen = false" class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs {{ $this->isActiveClass('admin.periode.index') }}">
